...
def direct_rrdo(objectives, constraints, trainer_args, start_samples, step_size, max_samples,
    ...
    if not res_key.endswith(f"_adapt_mean_svr_{start_samples}_{step_size}_{max_samples}_pred_res.pkl"):
        res_key += f"_adapt_mean_svr_{start_samples}_{step_size}_{max_samples}_pred_res.pkl"
